...
auth_channel = environ.get('-1002070438514')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://file2link:2TDBFQ2qwvafph1f@file2link.rxzed.mongodb.net/?retryWrites=true&w=majority&appName=File2Link")
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://graph.org/file/e4b2b1c88153071e54841.jpg")
...
# url shortner
SHORT_URL = environ.get("ez4short.com")
SHORT_API = environ.get("4491dd753120960a1c3bf360cf45fae06c2e6eb6")
